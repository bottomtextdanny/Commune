...
import net.bottomtextdanny.braincell.mod.entity.psyche.extras.BCAABBs;
import net.bottomtextdanny.braincell.mod.entity.psyche.extras.TargetConsumers;
import net.bottomtextdanny.braincell.mod.entity.psyche.extras.TargetSideReaction;
...
public class GoblinPsyche extends Psyche<Goblin> {
    ...
    private MoveReactionToEntityAction<Goblin> mountPeerAction;
    ...
    private boolean isValidPeer(Goblin mob, @Nonnull Goblin peer) {
        double distance = ReachHelper.reach(mob, peer, DistanceCalc.EUCLIDEAN);
    ...
    protected static abstract class GoblinHandedAttackAction extends Action<Goblin> {
        ...
        protected void update() {
            ...
            LivingEntity target = this.mob.getTarget();
            TargetPredicate validator = getPsyche().getInputs().getOfDefault(ActionInputKey.TARGET_VALIDATOR);
